...
def register_user(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(request, 'email_confirmation_signup_message.html', {'username': username, 'code': code})
...
def yandex_redirect(request):
    # Отобразите вашу вспомогательную страницу
    return render(request, 'allauth_email.html')
